...
- **Pacing i Allio:** `PREDICTIVE` på **kampagne-arbejd** bruger ikke længere heartbeat-dispatch; **power**-kampagner bruger stadig dispatch med ratio 1.0. (Historisk predictive-dispatch med dynamisk ratio findes stadig i `lib/dialer-pacing.ts` hvis endpoint kaldes manuelt.)
